...
(function() {
	...
	const propAPI = {
		...
		getBoundingClientRect: ['prototype.getBoundingClientRect', 3],
		getClientRects: ['prototype.getClientRects', 3],
		offsetWidth: ['HTMLElement.prototype.offsetWidth', 3],
		offsetHeight: ['HTMLElement.prototype.offsetHeight', 3],
